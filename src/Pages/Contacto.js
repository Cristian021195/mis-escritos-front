  ...
  return (
    <div className='animate__animated animate__fadeInUp d-flex justify-content-center row my-15'>
      ...
      <section className='text-center'>
        ...
        <a href='https://cristian021195.github.io/portfolio/' className='mt-5 leaf' alt='Link de portfolio personal, cristian021195.github.io/portfolio/' target='_blank' rel='noopener noreferrer'>Ver Portfolio</a>
      </section>
    </div>
  )
}
