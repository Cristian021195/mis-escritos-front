    ...
    <div className='animate__animated animate__fadeInUp'>
      ...
      <section className='row d-flex justify-content-center'>
        ...
        {data.data === undefined ? <p className='text-center'>Cargando..</p> :
         data.data.map((res, res_i)=><Escrito titulo={res.titulo} key={res_i} id_escrito={res.id_escrito} escrito={res.escrito} fecha={res.fecha} autor={res.autor} contacto={res.contacto}/>)}
      </section>
    </div>
  )
}